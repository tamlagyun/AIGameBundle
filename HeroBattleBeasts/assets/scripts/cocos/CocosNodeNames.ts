export type CocosLayerKey = 'background' | 'world' | 'effects' | 'hud' | 'modal';

export type CocosLayerPlanItem = {
  key: CocosLayerKey;
  nodeName: string;
};

export const COCOS_NODE_NAMES: Record<string, string> = {
...
export function getCocosLayerPlan(): CocosLayerPlanItem[] {
  return [
